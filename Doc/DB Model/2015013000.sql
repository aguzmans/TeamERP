...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 30, 2015 at 03:14 PM
...
CREATE TABLE IF NOT EXISTS `customer` (
  ...
  PRIMARY KEY (`id`),
  KEY `IDX_784FEC5F979B1AD6` (`company_id`)
...
INSERT INTO `customer` (`id`, `company_id`, `customer_name`, `address`, `postal_address`, `city_town_village`, `e_mail`, `land_line`, `cell_phone`, `fax`) VALUES
(1, 1, 'Abel', 'Calle 52 # 60, % 3era y G. Quezada, Nuevo Sosa', '75100', 'Las Tunas', 'abel@ltu.sld.cu', '346386', NULL, NULL),
(2, 3, 'Kay', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(4, 28, 'Anouk Van Der Geest', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(5, 29, 'Fred', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(7, 10, 'Ronja', 'Gaborone', NULL, NULL, NULL, NULL, NULL, NULL),
(11, 34, 'Peter', 'Airport', 'PO Box 1312', 'Gaborone', 'peter@airbotswana.co.bw', '345345', '345345', '34534534'),
(12, 35, 'Lilebo', 'Plot 34657, BroadHurst Industrial', 'PO Box 1312', 'Gaborone', 'lilebo@5flies.com', '432566', '788965', '5645344'),
(13, 10, 'Abdel', 'adsjhfdasf', 'asdfasd', 'asdfa', 'abdel@casa.ltu.cu', NULL, NULL, NULL);
...
(2, 'abel', 'abel', 'abel@ltu.sld.cu', 'abel@ltu.sld.cu', 1, 't70yo34lk2s4s4o4owkc0cc8sggs4k8', '8emNg5PJQOE3K4vVqgVvF+ptZcbBCbV7kw+Qk2OXQabaj3z2tq0lrFlM1JfNrUONW1qEaNI9QAPMCLlrcSBjkg==', '2015-01-30 09:59:02', 0, 0, NULL, NULL, NULL, 'a:1:{i:0;s:15:"ROLE_USER_SALES";}', 0, NULL);
